(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_77fcae6a._.js", {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JobsPage.useEffect": ()=>{
            const fetchJobListings = {
                "JobsPage.useEffect.fetchJobListings": async ()=>{
                    ...
                    try {
                        ...
                        if (data.results) {
                            const formattedListings = data.results.map({
                                "JobsPage.useEffect.fetchJobListings.formattedListings": (job)=>({
                                        title: job.title,
                                        company: job.company.display_name,
                                        description: job.description,
                                        applyUrl: job.redirect_url
                                    })
                            }["JobsPage.useEffect.fetchJobListings.formattedListings"]);
                            // Filter job listings based on experience level
                            const filteredListings = experienceLevel ? formattedListings.filter({
                                "JobsPage.useEffect.fetchJobListings": (listing)=>listing.description.toLowerCase().includes(experienceLevel.toLowerCase())
                            }["JobsPage.useEffect.fetchJobListings"]) : formattedListings;
            ...
            }["JobsPage.useEffect.fetchJobListings"];
            fetchJobListings();
        }
    }["JobsPage.useEffect"], [
        jobTitle,
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        jobListings.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(JobsPage, "mMA1Uiw7Xq9DUg57PSQmbW4Dy4c=", false, function() {
    return [
...
//# sourceMappingURL=src_77fcae6a._.js.map