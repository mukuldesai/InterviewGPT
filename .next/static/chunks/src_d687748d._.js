(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_d687748d._.js", {
...
async function getJobListings(jobTitle, location, experienceLevel, salaryRange) {
    ...
    try {
        ...
        let formattedListings = jobResults.map((job)=>({
        ...
        if (experienceLevel) {
            formattedListings = formattedListings.filter((listing)=>listing.description.toLowerCase().includes(experienceLevel.replace('_', ' ')));
        }
...
//# sourceMappingURL=src_d687748d._.js.map